...
const schema = yup
  ...
  .shape({
    ...
    NEXT_PUBLIC_DASHBOARD_INFO_ALERT_MESSAGE: yup.string(),
    NEXT_PUBLIC_DASHBOARD_INFO_ALERT_URL: yup.string().test(urlTest),
    ...
    NEXT_PUBLIC_COSMOS_REST_API_URL: yup.string().test(urlTest),
