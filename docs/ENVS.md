...
| NEXT_PUBLIC_DASHBOARD_INFO_ALERT_MESSAGE | `string` | Message to display in the dashboard info alert banner. Used to direct users to alternative dashboards or resources. Could be a regular string or HTML code with embedded links. | - | - | `For more accurate details on balance, staking, and other information, visit <a href="http://34.173.52.123:3000" target="_blank" rel="noopener noreferrer">Shardeum Desktop</a>.` | v1.0.0+ |
